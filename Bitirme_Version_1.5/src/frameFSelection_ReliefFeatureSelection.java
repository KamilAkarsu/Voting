...
public class frameFSelection_ReliefFeatureSelection {
	public void Relief_FS_Run(Instances data,String File_Path,int ranker_number,String DataSet_Name) throws Exception
	{
			weka.filters.supervised.attribute.AttributeSelection filter1 = new weka.filters.supervised.attribute.AttributeSelection();
			ReliefFAttributeEval evaluater=new ReliefFAttributeEval();
			...
			saver.setFile(new File(File_Path+"\\"+"Relief_FS_"+DataSet_Name+"_to_"+ranker_number+"_attr.arff"));
			saver.writeBatch();
	}
}
